...
clear
xdg-open https://m.youtube.com/channel/UCy5Z4RnSKUHkIiBSjRobdUw
clear
time1="$( date +"%r" )"
...
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;83m[Installer thread/INFO]:\e[0m \x1b[38;5;87m The installation has been completed! You can now launch Ubuntu with << bash startubuntu.sh >> then << bash msf.sh >> \n"
printf "\e[0m"
